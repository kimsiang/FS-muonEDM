...
#ifndef GRADIENT_BFIELD_HH
#define GRADIENT_BFIELD_HH
...
class musrGradientField : public F04ElementField
{
  public:

    musrGradientField(G4double EMF[6], G4double half_X, G4double half_Y, G4double half_Z, G4LogicalVolume*, G4ThreeVector);

    virtual ~musrGradientField() {}
