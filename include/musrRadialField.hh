...
#ifndef RADIAL_BFIELD_HH
#define RADIAL_BFIELD_HH
...
class musrRadialField : public F04ElementField
{
  public:

    musrRadialField(G4double EMF[6], G4double half_X, G4double half_Y, G4double half_Z, G4LogicalVolume*, G4ThreeVector);

    virtual ~musrRadialField() {}
